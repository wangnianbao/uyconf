...
#
# 一个简单的 WAR&&静态代码 部署脚本, 执行时必须在uyconf-web目录下执行本脚本
#
...
#	$WAR_ROOT_PATH/uyconf-web.war  	生成的War包
...
#
# 线上配置的路径  ONLINE_CONFIG_PATH=/home/work/dsp/uyconf-rd/online-resources
# 需要预先设置在环境变量里
...
# 
# WAR要放的路径   WAR_ROOT_PATH=/home/work/dsp/uyconf-rd/war
# 需要预先设置在环境变量里
...
cp -rp output/uyconf-web.war  $WAR_ROOT_PATH
