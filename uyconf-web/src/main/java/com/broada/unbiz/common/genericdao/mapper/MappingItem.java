...
public class MappingItem {
    ...
    public MappingItem(Field field, Method setterMethod, Method getterMethod, Table.ColumnStyle columnStyle) {
    ...
    public static List<MappingItem> getMappingItems(Class<?> clazz) {
        ...
        for (Field f : fields) {
            ...
            // FIXME
            MappingItem item =
                    new MappingItem(f, set, get, (table != null) ? table.columnStyle() : Table.ColumnStyle.LOWER_CASE,
