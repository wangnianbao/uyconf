package com.broada.uyconf.web.service.roleres.service;
...
public class RoleResourceAspect {
     ...
     * @throws Throwable
     */
    @Around("anyPublicMethod() && @annotation(requestMapping) && !@annotation(com.broada.dsp.common.annotation.NoAuth)")
