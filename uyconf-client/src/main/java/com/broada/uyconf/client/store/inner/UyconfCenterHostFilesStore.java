...
public class UyconfCenterHostFilesStore {
    ...
    protected static final Logger LOGGER = LoggerFactory.getLogger(UyconfCenterHostFilesStore.class);

    private UyconfCenterHostFilesStore() {
    ...
    private static class SingletonHolder {
         ...
         * 静态初始化器，由JVM来保证线程安全
         */
        private static UyconfCenterHostFilesStore instance = new UyconfCenterHostFilesStore();
    }

    public static UyconfCenterHostFilesStore getInstance() {
