package com.broada.uyconf.core.test.restful;
...
public class RemoteMockServer {
    ...
    public static final String FILE_URL =
            "/api/config/file?version=1_0_0_0&app=uyconf_testcase&env=rd&key=confA.properties&type=0";
    ...
    public static final String EMPTY_FILE_URL =
            "/api/config/file?version=1_0_0_0&app=uyconf_testcase&env=rd&key=empty.properties&type=0";
    ...
    public static final String STATIC_FILE_URL =
            "/api/config/file?version=1_0_0_0&app=uyconf_testcase&env=rd&key=staticConf.properties&type=0";
    ...
    public static final String NON_ANOTATION_FILE_URL =
            "/api/config/file?version=1_0_0_0&app=uyconf_testcase&env=rd&key=atomserverl.properties&type=0";
    ...
    public static final String NON_ANOTATION_FILE_URL2 =
            "/api/config/file?version=1_0_0_0&app=uyconf_testcase&env=rd&key=atomserverm_slave.properties&type=0";
    ...
    public static final String ITEM_URL =
            "/api/config/item?version=1_0_0_0&app=uyconf_testcase&env=rd&key=keyA&type=1";
    public static final String CONTENT_TYPE = "application/json";
    public static final String DEFAULT_ITEM_VALUE = "1000";

    //
    public static final String LOCAL_DOWNLOAD_DIR = "./uyconf/download";
    public static final String LOCAL_DOWNLOAD_DIR_TEMP = "./uyconf/tmp/download";
    public static final String LOCAL_TARGET_DOWNLOAD_DIR = "./uyconf/download/target";
    ...
    public static final String ZOO_PREFIX_VALUE = "/uyconf";
}
